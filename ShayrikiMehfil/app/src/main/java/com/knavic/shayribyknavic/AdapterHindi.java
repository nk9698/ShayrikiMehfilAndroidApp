...
public class AdapterHindi extends RecyclerView.Adapter<AdapterHindi.MyViewHolder> {

private Context context;
private Activity activity;
private ArrayList joke_id, joke_title;

public AdapterHindi(Activity activity, Context context, ArrayList joke_id, ArrayList joke_title){
...
public void onClick(View view) {
        ...
        Intent modify_intent = new Intent(context.getApplicationContext(), ShowJokeHindi.class);
        modify_intent.putExtra("title", String.valueOf(joke_title.get(position)));
        modify_intent.putExtra("category","hindi");
