...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public CustomAdapter(Activity activity, Context context, ArrayList joke_id, ArrayList joke_title){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent modify_intent = new Intent(context.getApplicationContext(), ShowJoke.class);
                modify_intent.putExtra("title", String.valueOf(joke_title.get(position)));
                modify_intent.putExtra("category","gujarati");
